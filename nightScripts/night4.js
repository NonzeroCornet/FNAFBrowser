...
var ringingNoise = new Audio("/assets/sounds/ring.mp3");
  ...
  clockCycle = setInterval(() => {
    ...
    if (time == 1) {
      ...
      setTimeout(() => {
        ...
        document.cookie = "night = 5; expires=Tue, 19 Jan 2038 04:14:07 GMT; Domain=fnaj.jdbdu.org; path=/; SameSite=None; Secure";
        setTimeout(() => {
